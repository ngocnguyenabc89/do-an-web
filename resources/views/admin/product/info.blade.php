...
<div class="card">
    <div class="card-body">
        <!-- Content Row -->
        <form class="conatainer" action="{{ asset('admin/product/edit') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row d-flex justify-content-center">
                ...
                <a href="{{ url('admin/product/list') }}" class="btn btn-secondary">Quay Lại</a>
            </div>
