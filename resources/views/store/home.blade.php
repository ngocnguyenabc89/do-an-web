            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="about__text">
                        ...
                        <p>Ngôi nhà nhỏ "3Gs House" được thành lập từ những cô gái nhỏ có niềm đam mê to lớn với những chiếc bánh ngọt ngào. Hãy đến với cửa hàng để bắt đầu một ngày đẹp của bạn.</p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
        ...
        <div class="container">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{ asset("storage/product/$product->anh_san_pham") }}">
                        <div class="product__label">
                            <span>{{ $product->ten_danh_muc }}</span>
                        </div>
                    </div>
                    <div class="product__item__text">
                        <h6><a href="{{ url("shop/product/$product->ma_san_pham") }}">{{ $product->ten_san_pham }}</a></h6>
